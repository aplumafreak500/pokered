...
ENDM
	...
	const TX_SOUND_CRY_KABUTOPS ; $15
MACRO sound_cry_kabutops
	db TX_SOUND_CRY_KABUTOPS
ENDM

	const TX_SOUND_CRY_CLEFAIRY ; $16
MACRO sound_cry_clefairy
	db TX_SOUND_CRY_CLEFAIRY
ENDM

	const TX_SOUND_CRY_PIDGEOT ; $17
MACRO sound_cry_pidgeot
	db TX_SOUND_CRY_PIDGEOT
ENDM

	const TX_SOUND_CRY_DEWGONG ; $18
