...
.animationLoop
	...
	vc_hook_green Stop_reducing_move_anim_flashing_Reflect
...
LoadSubanimation:
	...
	vc_hook_green Reduce_move_anim_flashing_Blizzard
	ld a, [wSubAnimAddrPtr]
	vc_hook_red Reduce_move_anim_flashing_Self_Destruct
	vc_hook_green Reduce_move_anim_flashing_Self_Destruct
	ld l, a
	ld a, [hli]
	ld e, a
	...
	vc_hook_green Reduce_move_anim_flashing_Rock_Slide
...
.moveAnimation
	...
	vc_hook_green Stop_reducing_move_anim_flashing_Bubblebeam_Mega_Kick
...
.next4
	...
	vc_hook_green Stop_reducing_move_anim_flashing
...
.endOfPalettes
	...
	pop hl
	jr nz, .loop
	vc_hook Stop_reducing_move_anim_flashing_Psychic
	ret
