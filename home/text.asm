...
.play
	...
	jr z, .pokemonCry
	cp TX_SOUND_CRY_KABUTOPS
	jr z, .pokemonCry
	cp TX_SOUND_CRY_CLEFAIRY
	jr z, .pokemonCry
...
TextCommandSounds::
	...
	db TX_SOUND_CRY_KABUTOPS,         KABUTOPS ; used in OakSpeech
	db TX_SOUND_CRY_CLEFAIRY,         CLEFAIRY ; used in OakSpeech
