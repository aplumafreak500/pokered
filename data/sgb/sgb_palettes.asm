...
ENDC
IF DEF(_GREEN)
	RGB 31,29,31, 30,26,04, 17,24,11, 03,02,02 ; PAL_SLOTS2
	RGB 31,29,31, 27,15,20, 21,25,17, 03,02,02 ; PAL_SLOTS3
	RGB 31,29,31, 16,16,29, 21,25,17, 03,02,02 ; PAL_SLOTS4
ENDC
IF DEF(_BLUE)
